#!/usr/bin/env python3
"""
Report Generation Script for Global Patent Intelligence Pipeline

This script generates console reports, CSV files, and JSON reports
from the patent analysis results.
...
class PatentReportGenerator:
    ...
    def __init__(self, output_dir: str = "../Pipeline/reports"):
        """
        ...
        self.analyzer = PatentDataAnalyzer(db_path="../Pipeline/patents.db", schema_path="../database_file/schema.sql")
